...
export const translations = {
    ...
    kz: {
        ...
        cart: {
            ...
            submitError: 'Тапсырысты жіберу сәтсіз. Қайталап көріңіз.',
            ...
            unavailableWarning: 'Кейбір тауарлар қол жетімді емес',
            removeUnavailable: 'Жою',
            unavailableItem: 'Тауар қол жетімді емес',
            removeItem: 'Жою',
        },
        customOrder: {
            title: 'Жеке',
    ...
    en: {
        ...
        cart: {
            ...
            emptyDesc: 'Add items from the catalog',
            ...
            goToCart: 'Go to Cart',
            unavailableWarning: 'Some items are no longer available',
